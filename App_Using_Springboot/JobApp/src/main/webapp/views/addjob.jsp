			...
			<div class="card">
				<div class="card-body">
					...
					<form action="handleForm" method="post">
						...
						<div class="mb-1">
							<label for="postContent" class="form-label">Post Description</label>
							<textarea class="form-control" id="postContent" name="postContent" rows="2" required></textarea>
						</div>
						...
						<div class="mb-2">
							...
							<select multiple class="form-select" id="techStack" name="techStack" required>
